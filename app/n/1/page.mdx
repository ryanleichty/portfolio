...
## 2. **Reverse-search a Git log by file _content_**
...
## 5. **Measure _anything_ with `time` + subshell**
...
> 💡 _Pro-tip:_ wrap this in a `pre-push` hook so slow commands get caught early.
